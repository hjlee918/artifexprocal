...
export const commands = {
	...
	setActiveCorrectionMatrix: (matrix: [([number, number, number]), ([number, number, number]), ([number, number, number])]) => __TAURI_INVOKE<null>("set_active_correction_matrix", { matrix }),
	clearActiveCorrectionMatrix: () => __TAURI_INVOKE<null>("clear_active_correction_matrix"),
	getActiveCorrectionMatrix: () => __TAURI_INVOKE<[([number, number, number]), ([number, number, number]), ([number, number, number])] | null>("get_active_correction_matrix"),
