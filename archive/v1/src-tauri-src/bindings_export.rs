...
export const {
	...
	abortProfiling,
	exportProfilingCcmx,
	setActiveCorrectionMatrix,
	clearActiveCorrectionMatrix,
	getActiveCorrectionMatrix,
    ...
    fn export_typescript_bindings() {
        let builder = tauri_specta::Builder::<tauri::Wry>::new()
            ...
            .commands(tauri_specta::collect_commands![
                ...
                crate::ipc::commands::set_active_correction_matrix,
                crate::ipc::commands::clear_active_correction_matrix,
                crate::ipc::commands::get_active_correction_matrix,
