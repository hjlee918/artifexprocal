...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            ipc::commands::set_active_correction_matrix,
            ipc::commands::clear_active_correction_matrix,
            ipc::commands::get_active_correction_matrix,
            ipc::commands::start_manual_calibration,
            ipc::commands::measure_manual_patch,
            ipc::commands::next_manual_patch,
            ipc::commands::prev_manual_patch,
            ipc::commands::skip_manual_patch,
            ipc::commands::finish_manual_calibration,
            ipc::commands::abort_manual_calibration,
            ipc::commands::get_manual_calibration_state,
